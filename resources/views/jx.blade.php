...
<div class="head1" style="background: url('./images/IMG_0733_05.jpg') repeat">
    <dl>
        <dt><img src="<?php echo "http://admin.daphp.top/".$one[0]->spe_img;?>" alt="" width="220px" height="220px"></dt>
        <dd><b>{{$one[0]->spe_name}}</b></dd>
        <dd>最美的专辑，最好听的歌</dd>
...
<div class="head2">
    <div class="play">
        <a href="chajian?spe_id={{$one[0]->spe_id}}"><img src="./images/IMG_0732_06.jpg" alt=""><h1 id="song">全部播放 {{count($data)}}首</h1></a>
    </div>
    @foreach($data as $k => $v)
        <div class="play1">
            <dl>
                <dt><a href="chajian?ifid={{$one[0]->spe_id}}"><img src="http://admin.daphp.top{{$v['music_img']}}" class="photo" alt=""></a></dt>
